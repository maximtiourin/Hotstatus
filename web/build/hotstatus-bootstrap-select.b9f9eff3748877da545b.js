...
/******/ 	return __webpack_require__(__webpack_require__.s = "./assets/js/hotstatus-bootstrap-select.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./assets/js/hotstatus-bootstrap-select.js":
/*!*************************************************!*\
  !*** ./assets/js/hotstatus-bootstrap-select.js ***!
  \*************************************************/
  ...
  (function ($) {
    ...
    Selectpicker.prototype = {
      ...
      createDropdown: function createDropdown() {
        ...
        var actionsbox = this.multiple && this.options.actionsBox ? '<div class="bs-actionsbox">' + '<div class="btn-group btn-group-sm btn-block">' + '<div class="d-inline-block" style="width:100%"></div><button type="button" class="actions-btn bs-select-toggle btn btn-default d-inline-block">' + this.options.selectAllText + '</button>' + '</div>' + '</div>' : '';
      ...
      render: function render(updateLi) {
        ...
        var selectedItemsCount = $selectOptions.filter(function () {
        ...
        var selectedItems = $selectOptions.map(function () {
          if (this.selected) {
            ...
            if (typeof $this.attr('title') !== 'undefined' && selectedItemsCount > 1) {
