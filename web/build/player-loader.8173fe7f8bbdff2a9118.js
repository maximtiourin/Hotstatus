...
PlayerLoader.data = {
    matches: {
        ...
        generateFullmatchRow: function generateFullmatchRow(container, player) {
            ...
            '<div class="rm-fm-r-heroimage-container">' + '<span data-toggle="tooltip" data-html="true" title="' + player.hero + '"><div class="rm-fm-r-herolevel">' + player.hero_level + '</div><img class="rm-fm-r-heroimage" src="' + player.image_hero + '"></span>' + '</div>' + '</div>';
